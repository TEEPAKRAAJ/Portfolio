      ...
      <div className="relative z-10 max-w-7xl w-full px-6 py-16 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center lg:justify-start">
            ...
            <a href="#showcase" className="px-6 py-3 border border-cyan-300 text-cyan-300 rounded-full font-semibold hover:bg-gradient-to-tr hover:from-blue-600 hover:via-cyan-400 hover:to-blue-600 hover:text-blue-950 hover:scale-105 transition">View Highlights</a>
          </div>
